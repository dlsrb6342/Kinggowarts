(function ()
{
    ...
    //main
        ...
        service.tutorialMarkObjList.push(new tutorialMarkObj('user-menu-drop-down', "-line", 30, 50, 50, -300,'100px', '100px',new defaultConfig(), PanelDialogCtrl, 'app/main/tutorialHtml/userMenuDropDownTutorial.html', service.tutorialMarkObjList.length, "", false, 1.0));
        service.tutorialMarkObjList.push(new tutorialMarkObj('user-menu-drop-down', "-button", -20, 140, 50, -300,'100px', '100px',new defaultConfig(), PanelDialogCtrl, 'app/main/tutorialHtml/userMenuDropDownTutorial.html', service.tutorialMarkObjList.length, "메인메뉴", false, 1.0));
        
        service.tutorialMarkObjList.push(new tutorialMarkObj('user-menu-right-toolbar', "-line", 30, 50, 50, -300,'100px', '100px',new defaultConfig(), PanelDialogCtrl, 'app/main/tutorialHtml/userMenuRightToolbarTutorial.html', service.tutorialMarkObjList.length, "", false, 1.0));
        service.tutorialMarkObjList.push(new tutorialMarkObj('user-menu-right-toolbar', "-button", -20, 140, 50, -300,'100px', '100px',new defaultConfig(), PanelDialogCtrl, 'app/main/tutorialHtml/userMenuRightToolbarTutorial.html', service.tutorialMarkObjList.length, "계정버튼", false, 1.0));
        
        service.tutorialMarkObjList.push(new tutorialMarkObj('search-bar-exp', "-line", 28, 50, 50, -300,'60px', '60px',new defaultConfig(), PanelDialogCtrl, 'app/main/tutorialHtml/searchBarExpTutorial.html', service.tutorialMarkObjList.length, "", false, 1.0));
        service.tutorialMarkObjList.push(new tutorialMarkObj('search-bar-exp', "-button", -20, 100, 50, -300,'60px', '60px',new defaultConfig(), PanelDialogCtrl, 'app/main/tutorialHtml/searchBarExpTutorial.html', service.tutorialMarkObjList.length, "검색", false, 1.0));
         
        service.tutorialMarkObjList.push(new tutorialMarkObj('quick-panel-toggle', "-line",  28, 50, 50, -300,'100px', '100px',new defaultConfig(), PanelDialogCtrl, 'app/main/tutorialHtml/quickPanelToggleTutorial.html', service.tutorialMarkObjList.length, "", false, 1.0));
        service.tutorialMarkObjList.push(new tutorialMarkObj('quick-panel-toggle', "-button", -20, 140, 50, -300,'60px', '60px',new defaultConfig(), PanelDialogCtrl, 'app/main/tutorialHtml/quickPanelToggleTutorial.html', service.tutorialMarkObjList.length, "패널", false, 1.0));

        service.tutorialMarkObjList.push(new tutorialMarkObj('categoryButtonPCId', "-line", 40, 25, 50, -300,'100px', '100px',new defaultConfig(), PanelDialogCtrl, 'app/main/tutorialHtml/categoryButtonPCIdTutorial.html', service.tutorialMarkObjList.length, "", false, 1.0));
        service.tutorialMarkObjList.push(new tutorialMarkObj('categoryButtonPCId', "-button", -15, 120, 50, -300,'100px', '100px',new defaultConfig(), PanelDialogCtrl, 'app/main/tutorialHtml/categoryButtonPCIdTutorial.html', service.tutorialMarkObjList.length, "카테고리버튼", false, 1.0));
        
        service.tutorialMarkObjList.push(new tutorialMarkObj('univ-button', "-line", 30, 25, 50, -300,'100px', '100px',new defaultConfig(), PanelDialogCtrl, 'app/main/tutorialHtml/univButtonTutorial.html', service.tutorialMarkObjList.length, "", false, 1.0));
        service.tutorialMarkObjList.push(new tutorialMarkObj('univ-button', "-button", -15, 115, 50, -300,'100px', '100px',new defaultConfig(), PanelDialogCtrl, 'app/main/tutorialHtml/univButtonTutorial.html', service.tutorialMarkObjList.length, "캠퍼스선택", false, 1.0));
        
        service.tutorialMarkObjList.push(new tutorialMarkObj('categoryButtonId', "-line", 20, -80, 50, -300,'100px', '100px',new defaultConfig(), PanelDialogCtrl, 'app/main/tutorialHtml/categoryButtonIdTutorial.html', service.tutorialMarkObjList.length, "", false, 1.0));
        service.tutorialMarkObjList.push(new tutorialMarkObj('categoryButtonId', "-button", -40, -120, 50, -300,'100px', '100px',new defaultConfig(), PanelDialogCtrl, 'app/main/tutorialHtml/categoryButtonIdTutorial.html', service.tutorialMarkObjList.length, "카테고리버튼", false, 1.0));
        
        service.tutorialMarkObjList.push(new tutorialMarkObj('userLocationButton', "-line", 20, -75, 50, -300,'100px', '100px',new defaultConfig(), PanelDialogCtrl, 'app/main/tutorialHtml/userLocationButtonTutorial.html', service.tutorialMarkObjList.length, "", false, 1.0));
        service.tutorialMarkObjList.push(new tutorialMarkObj('userLocationButton', "-button", -40, -105, 50, -300,'100px', '100px',new defaultConfig(), PanelDialogCtrl, 'app/main/tutorialHtml/userLocationButtonTutorial.html', service.tutorialMarkObjList.length, "내 위치 확인", false, 1.0));
        
        service.tutorialMarkObjList.push(new tutorialMarkObj('dragBar', "-line", -50, 0, 50, -300,'50px', '50px',new defaultConfig(), PanelDialogCtrl, 'app/main/tutorialHtml/dragBarTutorial.html', service.tutorialMarkObjList.length, "", false, 1.0));
        service.tutorialMarkObjList.push(new tutorialMarkObj('dragBar', "-button", -140, -20, 50, -300,'100px', '100px',new defaultConfig(), PanelDialogCtrl, 'app/main/tutorialHtml/dragBarTutorial.html', service.tutorialMarkObjList.length, "드래그바", false, 1.0));
